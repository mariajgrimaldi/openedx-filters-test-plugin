#!/usr/bin/env python
"""
Package metadata for openedx_filters_test_plugin.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_filters_test_plugin', '__init__.py')
...
setup(
    name='openedx-filters-test-plugin',
    version=VERSION,
    description="""Used to create Open edX Filters steps for testing purposes""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/edx/openedx-filters-test-plugin',
    packages=[
        'openedx_filters_test_plugin',
    ],
    ...
    entry_points={
        "lms.djangoapp": [
            "openedx_filters_test_plugin = openedx_filters_test_plugin.apps:openedx_filters_test_plugin",
        ],
    }
)
