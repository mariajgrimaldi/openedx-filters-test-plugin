...
"""
openedx-filters-test-plugin documentation build configuration file.
...
project = 'openedx-filters-test-plugin'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'openedx-filters-test-plugin'
...
#
# html_title = 'openedx-filters-test-plugin v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Used to create Open edX Filters steps for testing purposes',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_filters_test_plugin'),
                os.path.join(root_path, 'openedx_filters_test_plugin/migrations')])
